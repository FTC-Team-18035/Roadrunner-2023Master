...
@Autonomous(name = "Backdrop Only Park Blue")
//Replace "Template" with your new program's file name.
public final class BackdropSideParkBlue extends LinearOpMode {
    public void runOpMode() throws InterruptedException {
        ...
        Actions.runBlocking(
                drive.actionBuilder(new Pose2d(0, 0, 0))
                        .strafeTo(new Vector2d(.5,0))   //drives forward slightly to prevent scraping against the wall
                        .strafeTo(new Vector2d(0,26))  //drives left 26"
                        .build());
    }
}
