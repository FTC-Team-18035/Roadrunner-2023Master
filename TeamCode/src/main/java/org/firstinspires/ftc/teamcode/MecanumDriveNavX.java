...
@Config
public final class MecanumDriveNavX {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveNavX.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveNavX.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveNavX.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveNavX.this.rightFront));
    ...
    public MecanumDriveNavX(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
